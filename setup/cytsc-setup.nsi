...
; 安装程序初始定义常量
!define PRODUCT_NAME "ChaoYuan TSC Tools"
!define PRODUCT_VERSION "1.0.0"
!define PRODUCT_PUBLISHER "cychina.cn, Inc."
...
!define MUI_FINISHPAGE_SHOWREADME "$INSTDIR\help\Readme.txt"
...
OutFile "TSCTool-setup.exe"
InstallDir "$PROGRAMFILES\ChaoYuan TSC Tools"
...
Section "MainSection" SEC01
  ...
  CreateDirectory "$SMPROGRAMS\ChaoYuan TSC Tools"
  CreateShortCut "$SMPROGRAMS\ChaoYuan TSC Tools\ChaoYuan TSC Tools.lnk" "$INSTDIR\CYRTSCConfig.exe"
  CreateShortCut "$DESKTOP\ChaoYuan TSC Tools.lnk" "$INSTDIR\CYRTSCConfig.exe"
...
Section -AdditionalIcons
  ...
  CreateShortCut "$SMPROGRAMS\ChaoYuan TSC Tools\Website.lnk" "$INSTDIR\${PRODUCT_NAME}.url"
  CreateShortCut "$SMPROGRAMS\ChaoYuan TSC Tools\Uninstall.lnk" "$INSTDIR\uninst.exe"
SectionEnd
...
Section Uninstall
  ...
  RMDir "$SMPROGRAMS\ChaoYuan TSC Tools"
